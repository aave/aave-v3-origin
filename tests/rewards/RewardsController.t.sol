...
} from "../../src/contracts/rewards/transfer-strategies/PullRewardsTransferStrategy.sol";
...
contract RewardsControllerTest is TestnetProcedures {
    ...
    function test_accrueRewards() public {
        ...
        vm.expectEmit(address(rewardsController));
        emit Accrued(usdxAToken, tokenList.usdx, alice, newAssetIndex, newAssetIndex, expectedRewardsAccrued);
