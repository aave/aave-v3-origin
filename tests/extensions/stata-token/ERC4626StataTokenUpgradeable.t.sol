...
import {
    ...
    IERC4626StataToken
} from "../../../src/contracts/extensions/stata-token/ERC4626StataTokenUpgradeable.sol";
...
contract ERC4626StataTokenUpgradeableTest is TestnetProcedures {
    ...
    function test_depositWithPermit_shouldRevert_emptyPermit_noPreApproval(uint128 unboundedAssets) external {
        ...
        vm.prank(user);
        erc4626Upgradeable.depositWithPermit(env.underlyingBalance, user, block.timestamp + 1000, sig, false);
    }
    ...
    function test_depositWithPermit_emptyPermit_underlying_preApproval(
        ...
        vm.prank(user);
        uint256 shares =
            erc4626Upgradeable.depositWithPermit(env.amountToDeposit, receiver, block.timestamp + 1000, sig, true);
    ...
    function test_depositWithPermit_emptyPermit_aToken_preApproval(
        ...
        vm.prank(user);
        uint256 shares =
            erc4626Upgradeable.depositWithPermit(env.amountToDeposit, receiver, block.timestamp + 1000, sig, false);
