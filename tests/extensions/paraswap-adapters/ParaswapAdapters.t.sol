...
} from "../../../src/contracts/extensions/paraswap-adapters/ParaSwapLiquiditySwapAdapter.sol";
import {
    ParaSwapRepayAdapter,
    IParaSwapAugustusRegistry
} from "../../../src/contracts/extensions/paraswap-adapters/ParaSwapRepayAdapter.sol";
import {
    ParaSwapWithdrawSwapAdapter
} from "../../../src/contracts/extensions/paraswap-adapters/ParaSwapWithdrawSwapAdapter.sol";
...
contract ParaswapAdaptersTest is TestnetProcedures {
    ...
    function setUp() public {
        ...
        paraSwapLiquiditySwapAdapter = new ParaSwapLiquiditySwapAdapter(
            IPoolAddressesProvider(report.poolAddressesProvider), IParaSwapAugustusRegistry(mockAugustusRegistry), carol
        );
    ...
    function test_swap_liquidity_flashloan() public {
        ...
        mockParaSwapAugustus.expectSwap(tokenList.weth, tokenList.usdx, amountToSwap, amountToSwap, expectedUsdxAmount);
        ...
        bytes memory augustusInput = abi.encodeWithSelector(
            mockParaSwapAugustus.swap.selector, tokenList.weth, tokenList.usdx, amountToSwap, expectedUsdxAmount
        );
        bytes memory encodedInput = abi.encode(
            tokenList.usdx, expectedUsdxAmount, 0, augustusInput, address(mockParaSwapAugustus), emptyPermit
        );
        ...
        vm.prank(alice);
        contracts.poolProxy
            .flashLoanSimple(address(paraSwapLiquiditySwapAdapter), tokenList.weth, amountToSwap, encodedInput, 0);
    }
    ...
    function test_swap_liquidity_permit_flashloan() public {
        ...
        bytes memory encodedInput = abi.encode(
            tokenList.usdx, expectedUsdxAmount, 0, augustusInput, address(mockParaSwapAugustus), permitInput
        );
    ...
    function test_reverts_offset_out_of_range_swap_liquidity_permit_flashloan() public {
        ...
        bytes memory encodedInput = abi.encode(
            tokenList.usdx, expectedUsdxAmount, 2, augustusInput, address(mockParaSwapAugustus), permitInput
        );
    ...
    function test_swapAndRepay() public {
        ...
        mockParaSwapAugustus.expectBuy(
            tokenList.weth, tokenList.usdx, amountToSwap, expectedUsdxAmount, expectedUsdxAmount
        );
        ...
        bytes memory augustusInput = abi.encodeWithSelector(
            mockParaSwapAugustus.buy.selector, tokenList.weth, tokenList.usdx, amountToSwap, expectedUsdxAmount
        );
    ...
    function test_swapAndRepay_no_collateral_leftovers() public {
        ...
        mockParaSwapAugustus.expectBuy(
            tokenList.weth, tokenList.usdx, amountToSwap - 1 ether, expectedUsdxAmount, expectedUsdxAmount
        );
    ...
    function test_swapAndRepay_flashloan() public {
        ...
        bytes memory flashLoanParams = abi.encode(tokenList.usdx, expectedUsdxAmount, 0, 2, augustusParams, emptyPermit);
        ...
        vm.prank(alice);
        contracts.poolProxy
            .flashLoanSimple(address(paraSwapRepayAdapter), tokenList.weth, amountToSwap, flashLoanParams, 0);
    }
    ...
    function test_swapAndRepay_flashloan_permit() public {
        ...
        bytes memory flashLoanParams = abi.encode(tokenList.usdx, expectedUsdxAmount, 0, 2, augustusParams, permitInput);
    ...
    function test_withdrawSwapAdapter_reverts_flashloan() public {
        ...
        contracts.poolProxy.flashLoanSimple(address(paraSwapWithdrawSwapAdapter), tokenList.weth, 1 ether, "", 0);
    }
