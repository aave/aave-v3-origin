...
contract ATokenEventsTests is TestnetProcedures {
    ...
    function _expectATokenSupplyEvents(
        ...
        uint256 balanceIncrease =
            scaledBalance.rayMul(index) - scaledBalance.rayMul(IAToken(aTokenAddress).getPreviousIndex(onBehalfOf));
    ...
    function _expectATokenWithdrawEvents(
        ...
        uint256 balanceIncrease =
            scaledBalance.rayMul(index) - scaledBalance.rayMul(IAToken(aTokenAddress).getPreviousIndex(user));
    ...
    function test_mintToTreasury_events() public {
        ...
        vm.expectEmit(address(aToken));
        emit Mint(address(contracts.poolProxy), aToken.RESERVE_TREASURY_ADDRESS(), amountToMint, 0, 1e27);
