...
contract VariableDebtTokenEventsTests is TestnetProcedures {
    ...
    function setUp() public {
        ...
        (,, address variableDebtUsdx) = contracts.protocolDataProvider.getReserveTokensAddresses(tokenList.usdx);
    ...
    function test_scaledBalanceOf() public {
        ...
        assertEq(variableDebtToken.scaledBalanceOf(alice), aliceAmount1.rayDiv(index1) + aliceAmount2.rayDiv(index2));
    }
