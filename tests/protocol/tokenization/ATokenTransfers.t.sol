...
contract ATokenTransferTests is TestnetProcedures {
    ...
    function setUp() public {
        ...
        (,, address variableDebtWBTC) = contracts.protocolDataProvider.getReserveTokensAddresses(tokenList.wbtc);
    ...
    function test_atoken_transfer_sets_enabled_as_collateral(uint64 timePassed, uint256 amount) public {
        ...
        (uint256 collateralBalance,,,,,,,, bool collateralEnabled) =
