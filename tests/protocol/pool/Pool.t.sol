...
contract PoolTests is TestnetProcedures {
    ...
    function test_reverts_setReserveInterestRateStrategyAddress_ZeroAssetAddress(address strategy) public {
    ...
    function test_reverts_setReserveInterestRateStrategyAddress_AssetNotListed(address asset, address strategy) public {
    ...
    function test_mintToTreasury() public {
        (,, address varDebtUSDX) = contracts.protocolDataProvider.getReserveTokensAddresses(tokenList.usdx);
