...
contract PoolLiquidationCloseFactorTests is TestnetProcedures {
        ...
        public
    {
        ...
        uint256 lowerBound =
            (LiquidationLogic.MIN_BASE_MAX_CLOSE_FACTOR_THRESHOLD * 10 ** IERC20Detailed(collateralAsset).decimals())
                / oraclePrice;
    ...
    function test_hf_gt_095_borrow_gt_threshold_collateral_lt_threshold_closeFactorShouldBe100() external {
        ...
        _supplyToPool(tokenList.usdx, bob, (LiquidationLogic.MIN_BASE_MAX_CLOSE_FACTOR_THRESHOLD - 1e8) / 1e2);
        ...
        uint256 supplyLtThreshold =
            ((LiquidationLogic.MIN_BASE_MAX_CLOSE_FACTOR_THRESHOLD - 1e8)
                    * 10
                    ** IERC20Detailed(tokenList.weth).decimals()) / oraclePrice;
