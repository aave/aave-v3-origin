...
contract PoolDeficitTests is TestnetProcedures {
    ...
    function test_eliminateReserveDeficit_parcial(address coverageAdmin, uint120 borrowAmount, uint120 amountToCover)
        public
    {
        _filterAddresses(coverageAdmin);
        uint256 currentDeficit = _createReserveDeficit(borrowAmount, tokenList.usdx);
    ...
    function test_reverts_eliminateReserveDeficit_reserve_not_in_deficit(address coverageAdmin) public {
        _filterAddresses(coverageAdmin);
