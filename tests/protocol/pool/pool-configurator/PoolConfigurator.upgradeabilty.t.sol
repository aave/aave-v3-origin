...
} from "../../../../src/contracts/protocol/pool/PoolConfigurator.sol";
...
contract PoolConfiguratorUpgradeabilityTests is TestnetProcedures {
    ...
    function test_setReserveInterestRateStrategyAddress() public {
        ...
        emit ReserveInterestRateStrategyChanged(
            tokenList.usdx, currentInterestRateStrategy, updatedInterestsRateStrategy
        );
        ...
        contracts.poolConfiguratorProxy
            .setReserveInterestRateStrategyAddress(
                tokenList.usdx, updatedInterestsRateStrategy, _getDefaultInterestRatesStrategyData()
            );
    ...
    function test_updateAToken() public {
        ...
        (address aTokenProxy,,) = contracts.protocolDataProvider.getReserveTokensAddresses(tokenList.usdx);
    ...
    function test_updateVariableDebtToken() public {
        (,, address variableDebtProxy) = contracts.protocolDataProvider.getReserveTokensAddresses(tokenList.usdx);
        ...
        assertEq(address(VariableDebtToken(variableDebtProxy).getIncentivesController()), input.incentivesController);
    }
