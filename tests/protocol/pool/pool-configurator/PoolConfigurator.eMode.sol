...
contract PoolConfiguratorEModeConfigTests is TestnetProcedures {
    ...
    function test_setAssetCollateralInEMode() public {
        ...
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(config.collateralBitmap, reserveData.id), true);
    }
    ...
    function test_addAnotherAssetCollateralInEMode() public {
        ...
        DataTypes.ReserveDataLegacy memory reserveDataWBTC = contracts.poolProxy.getReserveData(tokenList.wbtc);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(config.collateralBitmap, reserveDataUSDX.id), true);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(config.collateralBitmap, reserveDataWBTC.id), true);
    }
    ...
    function test_removeCollateralFromEmode() public {
        ...
        DataTypes.ReserveDataLegacy memory reserveData = contracts.poolProxy.getReserveData(tokenList.usdx);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(config.collateralBitmap, reserveData.id), false);
    }
    ...
    function test_setAssetBorrowableInEMode() public {
        ...
        DataTypes.EModeCategory memory config = _getFullEMode(input.id);
        DataTypes.ReserveDataLegacy memory reserveData = contracts.poolProxy.getReserveData(tokenList.usdx);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(config.borrowableBitmap, reserveData.id), true);
    }
    ...
    function test_addAnotherAssetBorrowableInEMode() public {
        ...
        DataTypes.ReserveDataLegacy memory reserveDataUSDX = contracts.poolProxy.getReserveData(tokenList.usdx);
        DataTypes.ReserveDataLegacy memory reserveDataWBTC = contracts.poolProxy.getReserveData(tokenList.wbtc);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(config.borrowableBitmap, reserveDataUSDX.id), true);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(config.borrowableBitmap, reserveDataWBTC.id), true);
    }
    ...
    function test_removeBorrowableFromEmode() public {
        ...
        DataTypes.EModeCategory memory config = _getFullEMode(input.id);
        DataTypes.ReserveDataLegacy memory reserveData = contracts.poolProxy.getReserveData(tokenList.usdx);
        assertEq(EModeConfiguration.isReserveEnabledOnBitmap(config.borrowableBitmap, reserveData.id), false);
    }
