...
contract CryticToFoundry is Invariants, Setup {
    ...
    function test_v32_2_borrow() public {
        ...
        this.approveDelegation(1482526189130252178123437018605205213532554266044322803735452163998541884248, 226, 251);
    ...
    function test_v32_setPoolPause() public {
        ...
        _delay(534073, 1953);
        Tester.increaseAllowance(2903000394675170785137978058613790841450925157038471986390143556336053766387, 32, 0);
        _delay(322295, 18582);
        Tester.setUserUseReserveAsCollateral(false, 115);
        _delay(348682, 54175);
        Tester.increaseAllowance(42925595869256018644087582406413896859640439692615489585536378306598920896616, 128, 90);
        _delay(531977, 11565);
        ...
        _delay(533788, 46068);
        _delay(578021, 4029);
        Tester.increaseAllowance(440958157672998905105592764771506942420834309123016558302398494718463910559, 70, 109);
        _delay(614330, 99857);
        _delay(235662, 57086);
    ...
    function test_replay_V33_transferFrom() public {
        ...
        Tester.borrow(10, 0, 2);
        _delay(571677);
        Tester.increaseAllowance(6273176033789177866065594142720493832380394006134877985919878609507187554376, 241, 11);
        _delay(4444503);
        _setUpActor(0x0000000000000000000000000000000000020000);
        _delay(5999);
        Tester.transferFrom(13, 237, 203, 77967604747426594918862951366170156297569950523258733931584971918416530236914);
    }
    ...
    function test_replay_v33_borrow() public {
        ...
        _delay(82672);
        Tester.setLatestAnswer(8297305240048690104559311266951712284695941564805536635134314972350744968943, 161);
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(332369);
        Tester.donateUnderlying(96632813453761016924137105566782796567896479502322553834458859805073736090880, 53);
        _setUpActor(0x0000000000000000000000000000000000020000);
        _delay(407328);
        ...
        Tester.increaseAllowance(
            100686595376288898789091393373158066141873755820473760922441694199724445608207, 255, 255
        );
        _delay(533862);
        _delay(241250);
        ...
        Tester.approveDelegation(
            115792089237316195423570985008687907853269984665640564039457584007910753493070, 255, 56
        );
        _delay(3946136);
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(463588);
        Tester.borrow(20187168876775220233720774761258734003521555161596916184656049765614623609022, 253, 141);
        _setUpActor(0x0000000000000000000000000000000000030000);
        _delay(585506);
    ...
    function test_replay_v33_liquidationCall() public {
        ...
        Tester.liquidationCall(
            96116319240538101021441800223011440398035853240172630474486511372044082416607, false, 0, 2, 2, 0
        );
    }
    ...
    function test_replay_v33_3liquidationCall() public {
        ...
        Tester.approve(85816025910022903715357347415778016859141149493197187365595267387137827715779, 0, 5);
        _delay(322182);
        Tester.updateBridgeProtocolFee(30);
        _delay(112516);
        Tester.repay(115792089237316195423570985008687907853269984665640564039457584007913129639933, 23, 110);
        _delay(243803);
        Tester.approve(65609807886680263139209343924550770393978137453194200189176562977589895282170, 6, 177);
        _delay(585505);
        Tester.increaseAllowance(26091149535616436666993674031014365215554587051967826255295155471152712491920, 7, 0);
        _delay(1433009 + 389576);
        Tester.setLatestAnswer(15961020187089609539994664005862511207456112520921648682428095379252895341460, 86);
        _delay(571389);
        Tester.setLatestAnswer(12110082393770152637771864563855718214753398550442805668132194565202580299239, 95);
    ...
    function test_replay_v33_echidna_BORROWING_INVARIANT_B() public {
        ...
        Tester.borrow(9, 0, 2);
        _delay(249243);
        Tester.approveDelegation(96559532227550485757689127554436600813492672962756024016014493407936459690099, 138, 5);
        _delay(797176);
        _delay(322163);
        ...
        _delay(263947);
        _delay(494836);
        Tester.repay(113460169279075452955927818204721906413602155416877199543651084515419479895901, 199, 99);
        _delay(1318719);
        _delay(453829);
        Tester.setReserveBorrowing(false, 76);
        _delay(486059);
        Tester.approve(64349701272837019632051932641313431036955485130917153021714579928156825285075, 206, 1);
        _delay(2982799);
        _delay(321976);
        Tester.approveDelegation(343742201451480911781285470307753062059237751591242006381088082742779877065, 57, 2);
        _delay(365349);
        Tester.repayWithATokens(115792089237316195423570985008687907853269984665640564039457584007844410163201, 78);
        _delay(3182445);
        _delay(453882);
        Tester.disableLiquidationGracePeriod(7);
        _delay(554800);
        _delay(364254);
        Tester.donateUnderlying(33337808402080397431805607158584434285128862021942434413263860547193192284972, 62);
        _delay(444062);
        _delay(526194);
        Tester.setBorrowableInIsolation(false, 59);
        _delay(23659);
        Tester.repayWithATokens(115792089237316195423570985008687907853269984665640564039457584007913129639931, 22);
        _delay(254064);
        Tester.repay(14496732263044785785643510598825711964785226055010338430033690695699625410654, 13, 116);
        _delay(314126);
        _delay(81125);
        Tester.donateUnderlying(53540767030399028531450202967299416451876520590810187251495755588218324309338, 8);
        _delay(118436);
        ...
        _delay(578493);
        Tester.borrow(56495079163379291484208169586838199933931760527964707990976030993653418545813, 231, 9);
        _delay(352898);
        ...
        _delay(444470);
        _delay(217367);
        Tester.increaseAllowance(99504725668169871490339201623232949640414720075879459043430204935223715829141, 84, 208);
        _delay(464605);
        _delay(322306);
        Tester.setSiloedBorrowing(false, 108);
        _delay(185610);
        _delay(243804);
        Tester.approve(115792089237316195423570985008687907853269984665640564039457584007912129639935, 77, 19);
        _delay(112516);
        Tester.setReserveActive(true, 129);
        _delay(294084);
        Tester.approve(24132821072604019452845433356869456752194585476275041561253141166468891111311, 252, 9);
        _delay(591193);
        _delay(472700);
        Tester.approveDelegation(
            115792089237316195423570985008687907853269984665640564039457584007913129639931, 108, 58
        );
        _delay(322124);
        _delay(197791);
        ...
        _delay(436728);
        Tester.liquidationCall(
            45314777003086831491907766032761308330683725952490920024602233352791613874361, false, 12, 80, 149, 12
        );
        _delay(323860);
        _delay(81127);
        ...
        _delay(322275);
        Tester.approveDelegation(
            115792089237316195423570985008687907853269984665640564039456584007913129639935, 49, 239
        );
        _delay(107457);
    ...
    function test_replay_v33_echidna_BORROWING_INVARIANT_C() public {
        ...
        Tester.borrow(9, 0, 2);
        _delay(312476);
        Tester.donateUnderlying(38597363079105398474523661669562635951089994888546854679819194669304376546646, 152);
        _delay(497065);
        _setUpActor(0x0000000000000000000000000000000000020000);
        _delay(150663);
        ...
        _delay(395237);
        _delay(201910);
        Tester.increaseAllowance(115792089237316195423570984634549197687329661445021480007966928956539929624577, 52, 50);
        _delay(150273);
        Tester.disableLiquidationGracePeriod(60);
        _setUpActor(0x0000000000000000000000000000000000020000);
        _delay(372377);
        ...
        _delay(85184);
        Tester.approveDelegation(
            84875307276726038152192332581522015542772245101417910105142414348553559208135, 107, 104
        );
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(99999);
        Tester.approveDelegation(1613474119862448886066051152177351161896046623019441561857805191125617202734, 170, 68);
        _delay(992305);
        _delay(220715);
        Tester.approve(64349701272837019632051932641313431036955485130917153021714579928156825285075, 206, 1);
        _delay(322311);
        _delay(322317);
        Tester.increaseAllowance(48533652378942908258893408390091813604477137072018964141136305550863099289849, 0, 14);
        _setUpActor(0x0000000000000000000000000000000000020000);
        _delay(4500);
        Tester.borrow(1327428230, 18, 131);
        _delay(151630);
        Tester.approveDelegation(74911391484337287233966267409706790275863770848686748264948371050367839215021, 186, 60);
        _delay(930292);
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(322192);
        ...
        _delay(321976);
        Tester.approveDelegation(11279170954544410566632619763891525999672477049343347561993816970714309857791, 57, 16);
        _delay(365349);
        Tester.repayWithATokens(115792089237316195423570985008687907853269984665640564039457584007844410163201, 78);
        _delay(1552097);
        _delay(380129);
        ...
        _setUpActor(0x0000000000000000000000000000000000020000);
        _delay(410218);
        Tester.approveDelegation(1791444163243152098506318537516770225823353145304134936902401035756172599955, 17, 185);
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(453882);
        ...
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(567572);
        Tester.repayWithATokens(86987830605528395587543624303367251153705364798916692144644677933807453727485, 22);
        _delay(401);
        ...
        _setUpActor(0x0000000000000000000000000000000000020000);
        _delay(578493);
        Tester.borrow(48894047680164008559879478276387182687652521969141973255800075300778001534327, 41, 8);
        _delay(298366);
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(566551);
        ...
        _delay(238206);
        Tester.approve(115792089237316195423570985008687907853269984665640564039457584007913129639934, 211, 55);
        _delay(303271);
        _delay(111322);
        Tester.repayWithATokens(49008279356062424391164723044804177852197100800299611036025768231534049552023, 9);
        _delay(250896);
        ...
        _delay(465191);
        _delay(395199);
        Tester.approve(87247375124337106854136739660572870865681418592845079988592088127092848022159, 34, 30);
        _delay(469355);
        _delay(144683);
        Tester.liquidationCall(
            91352034832010926057001582751876410893860910903135406657784615168643518944325, false, 66, 212, 254, 1
        );
        _delay(322123);
        Tester.repayWithATokens(115792089237316195423570985008687907853269984665640564039457584007909683116410, 154);
        _delay(194499);
        _delay(64406);
        ...
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(436727);
        Tester.repayWithATokens(115792089237316195423570985008687907853269901588890828691141347134601036824577, 32);
        _delay(10674);
        ...
        _delay(2256055);
        _delay(10398);
        Tester.repayWithATokens(115792089237316195423570985008687907853269984665640564039457584007913129639785, 56);
        _delay(490449);
        _delay(4500);
        Tester.repay(2109560130, 100, 15);
        _delay(842143);
        _delay(3867);
        Tester.approve(115792089237316195423570985008687907853269984665640564039457584007910102077141, 251, 156);
        _delay(27813);
        ...
        _delay(782350);
        _delay(520990);
        Tester.repay(77232386750745558581303905139564453166287326505119739309730359179889410133315, 157, 244);
        _delay(6802);
        _delay(546907);
        Tester.disableLiquidationGracePeriod(6);
        _delay(149663);
        Tester.repay(67359618506568000212646106642539893122243724545192200452839073930112048359477, 17, 170);
        _delay(253494);
        Tester.setSiloedBorrowing(true, 0);
        _delay(542442);
        Tester.increaseAllowance(115012468444674537867220117441548077362522847310802063480314356408727965612211, 59, 2);
        _delay(1108106);
        _delay(71687);
        Tester.repay(39132476607653690839561857087648235157409873820928650868326386624556317152240, 252, 154);
        _delay(28290);
        Tester.liquidationCall(
            5905935794222959591038105642016884250145820458264270399654189534678713257883, true, 211, 128, 3, 4
        );
        _delay(321974);
        ...
        _delay(314382);
        Tester.approve(115792089237316195423570985008687907853269984665640564039457584007913129639777, 175, 9);
        _setUpActor(0x0000000000000000000000000000000000020000);
        _delay(322231);
