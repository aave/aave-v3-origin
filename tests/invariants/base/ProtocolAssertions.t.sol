...
contract ProtocolAssertions is StdAsserts, BaseTest {
    ...
    function assertAssetsBorrowableInEmode(address[] memory assets, uint8 eModeCategory, string memory reason)
        internal
    {
    ...
    function assertReserveGracePeriodIsSetAllReserves(uint40 gracePeriod, string memory reason) internal {
    ...
    function assertReserveGracePeriodIsSet(uint40 gracePeriod, address asset, string memory reason) internal {
