...
contract AaveV3PermissionsTest is BatchTestProcedures {
    ...
    function testCheckPermissions() public {
        ...
        }
        {
            ...
            assertEq(paraswapRepayAdapterOwner, roles.poolAdmin, "roles.poolAdmin must be paraswap repay owner");
            assertEq(paraswapSwapAdapterOwner, roles.poolAdmin, "roles.poolAdmin must be paraswap liquidity swap owner");
            assertEq(paraswapWithdrawSwapOwner, roles.poolAdmin, "roles.poolAdmin must be paraswap withdraw swap owner");
        }
        {
    ...
    function testCheckPermissionsTreasuryPartner() public {
        ...
        }
        {
            ...
            assertEq(
                revenueSplitterPartnerA, report.treasury, "RevenueSplitter recipient A does not match report.treasury"
            );
            assertEq(
