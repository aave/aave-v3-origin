...
contract DeploymentsGasLimits is BatchTestProcedures {
    ...
    function setUp() public {
        ...
        (,, gettersReportTwo,, setupReportTwo,, miscReport, tokensReport, paraswapReportOne,) =
    ...
    function test2AaveV3GettersBatch2Deployment() public {
        new AaveV3GettersBatchTwo(setupReportTwo.poolProxy, roles.poolAdmin, config.wrappedNativeToken, flags.l2);
    }
