...
contract WrappedTokenGatewayTests is TestnetProcedures {
    ...
    function test_withdrawEth_partial() public {
        ...
        vm.expectEmit();
        emit Withdraw(tokenList.weth, report.wrappedTokenGateway, report.wrappedTokenGateway, partialWithdraw);
    ...
    function test_withdrawEth_permit() public {
        ...
        vm.expectEmit();
        emit Withdraw(tokenList.weth, report.wrappedTokenGateway, report.wrappedTokenGateway, withdrawAmount);
    ...
    function test_withdrawEth_permit_full() public {
        ...
        vm.expectEmit();
        emit Withdraw(tokenList.weth, report.wrappedTokenGateway, report.wrappedTokenGateway, userATokenBalance);
    ...
    function test_withdrawEth_full() public {
        ...
        uint256 userEthBalanceBefore = alice.balance;
        vm.expectEmit();
        emit Withdraw(tokenList.weth, report.wrappedTokenGateway, report.wrappedTokenGateway, fullWithdraw);
