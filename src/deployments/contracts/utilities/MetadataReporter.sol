...
contract MetadataReporter is IMetadataReporter {
    ...
    function writeJsonReportMarket(MarketReport memory report) external {
        ...
        vm.serializeAddress(jsonReport, "paraSwapLiquiditySwapAdapter", report.paraSwapLiquiditySwapAdapter);
        vm.serializeAddress(jsonReport, "paraSwapWithdrawSwapAdapter", report.paraSwapWithdrawSwapAdapter);
        ...
        string memory output = vm.serializeAddress(jsonReport, "paraSwapRepayAdapter", report.paraSwapRepayAdapter);
