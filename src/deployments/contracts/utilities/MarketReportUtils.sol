...
library MarketReportUtils {
    function toContractsReport(MarketReport memory report) internal pure returns (ContractsReport memory) {
        return ContractsReport({
            poolAddressesProviderRegistry: IPoolAddressesProviderRegistry(report.poolAddressesProviderRegistry),
            ...
            defaultInterestRateStrategy: IDefaultInterestRateStrategyV2(report.defaultInterestRateStrategy),
            ...
            paraSwapLiquiditySwapAdapter: ParaSwapLiquiditySwapAdapter(report.paraSwapLiquiditySwapAdapter),
            paraSwapRepayAdapter: ParaSwapRepayAdapter(report.paraSwapRepayAdapter),
            paraSwapWithdrawSwapAdapter: ParaSwapWithdrawSwapAdapter(report.paraSwapWithdrawSwapAdapter),
