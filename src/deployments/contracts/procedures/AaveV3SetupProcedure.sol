...
} from "../../../contracts/protocol/configuration/PoolAddressesProviderRegistry.sol";
...
contract AaveV3SetupProcedure {
    ...
    function _setupACL(
        ...
        _configureFlashloanParams(manager, poolConfiguratorProxy, flashLoanPremiumTotal, flashLoanPremiumToProtocol);
