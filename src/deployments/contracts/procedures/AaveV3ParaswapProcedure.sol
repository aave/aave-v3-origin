...
} from "../../../contracts/extensions/paraswap-adapters/ParaSwapLiquiditySwapAdapter.sol";
...
} from "../../../contracts/extensions/paraswap-adapters/ParaSwapWithdrawSwapAdapter.sol";
...
contract AaveV3ParaswapProcedure {
    ...
    function _deployAaveV3ParaswapAdapters(
        ...
        ParaswapAdapters memory report = _deployParaswapAdapters(
            paraswapAugustusRegistry, poolAddressesProvider, poolAdmin
        );

        return report;
    }

    function _deployParaswapAdapters(address paraswapAugustusRegistry, address poolAddressesProvider, address poolAdmin)
        internal
        returns (ParaswapAdapters memory)
    {
