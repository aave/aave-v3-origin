...
contract DefaultReserveInterestRateStrategyV2 is IDefaultInterestRateStrategyV2 {
    ...
    modifier onlyPoolConfigurator() {
        require(msg.sender == ADDRESSES_PROVIDER.getPoolConfigurator(), Errors.CALLER_NOT_POOL_CONFIGURATOR);
        _;
    }
    ...
    function _setInterestRateParams(address reserve, InterestRateData memory rateData) internal {
        ...
        require(rateData.variableRateSlope1 <= rateData.variableRateSlope2, Errors.SLOPE_2_MUST_BE_GTE_SLOPE_1);
