...
contract MathUtilsWrapper {
    ...
    function calculateLinearInterest(uint256 rate, uint40 lastUpdateTimestamp) public view returns (uint256) {
    ...
    function calculateCompoundedInterest(uint256 rate, uint40 lastUpdateTimestamp) public view returns (uint256) {
